...
export default function FeaturesSection() {
    return (
        <div id="features" className="px-4 md:px-16 lg:px-24 xl:px-32">
            <SectionTitle text1="Features" text2="Powerful AI Tools" text3="Everything you need to create eye-catching thumbnails in minutes." />
            ...
            <div className="mt-40 relative mx-auto max-w-5xl">
                ...
                >
                    Our AI thumbnail generator helps creators turn ideas into scroll-stopping visuals—instantly, effortlessly, and at scale.
                </motion.p>
                <div className="grid grid-cols-1 md:grid-cols-3 mt-8 gap-10">
                    ...
                    >
                        ...
                        <h3 className="text-[24px]/7.5 text-slate-300 font-medium mt-6">Smarter thumbnails that get more clicks </h3>
                        <p className="text-slate-300 mt-2">Create professional-grade thumbnails that increase views, engagement, and channel growth—powered by AI.</p>
                        <a href="https://prebuiltui.com" className="group flex items-center gap-2 mt-4 text-pink-600 hover:text-pink-700 transition">
                            Explore AI Thumbnail Generator
