...
export default function TestimonialSection() {
    return (
        <div id="testimonials" className="px-4 md:px-16 lg:px-24 xl:px-32">
            <SectionTitle
                text1="Creator Stories"
                text2="Trusted by content creators"
                text3="See how YouTubers, streamers, and creators are using AI-powered thumbnails to increase clicks, views, and engagement."
            />
