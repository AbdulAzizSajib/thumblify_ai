...
export default function ContactSection() {
    return (
        <div className="px-4 md:px-16 lg:px-24 xl:px-32">
            <SectionTitle
                text1="Contact"
                text2="Talk with our team"
                text3="Have questions about AI thumbnails or pricing? Reach out and let’s help you grow your content faster."
            />
            ...
            >
                ...
                >
                    ...
                    <textarea
                        name="message"
                        rows={8}
                        placeholder="Tell us about your channel, ideas, or questions…"
